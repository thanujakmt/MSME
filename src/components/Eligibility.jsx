...
function Eligibility() {
    return (
        <div class="overflow-hidden shadow-lg w-screen p-6 bg-white p-4">
            <span class="text-orange-500 text-2xl py-5 font-bold">Easy Registration</span><br/>
            ...
            <span class="text-orange-500 text-2xl py-5 font-bold">Who Is Eligible For MSME Registration?</span><br/>
            <div class="flex px-5 pb-5 pt-2">
                    <ul class="list-disc">
            ...
            <span class="text-xs">If your investment in plant and machinery or equipment falls under the government’s MSME definition, you are eligible!</span>
        </div>
    );
}
