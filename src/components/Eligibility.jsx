...
function Eligibility() {
    return (
        <div class=" bg-white px-[20px]  2xl:px-[150px] py-[20px]">
            <span class="text-pale_yellow text-[26px] py-5 font-bold">Easy Registration</span>
            ...
            <span class="text-pale_yellow text-[26px] py-5 font-bold">Who Is Eligible For MSME Registration?</span>
            <div class="flex px-5 pb-5 pt-2">
                <ul class="list-disc text-[14px]">
