        ...
        <div>
            ...
            <div className="md:px-[20px]  2xl:px-[150px] py-[20px]">
                <div className='px-10 py-3'>
                    <p className='text-orange-500 text-2xl font-bold pb-2'>Forget Udyam registration</p>
                ...
                <div className='px-10 py-3'>
                    ...
                    <p className='flex flex-col text-sm'>
                        ...
                        <span className='pl-4 text-sm'>•  Mobile number (keep in mind that the mobile number is the same which is that mentioned in the Udyam certificate)</span>
