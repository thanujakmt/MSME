        ...
        <div className='flex flex-col'>
            ...
            <div class="my-3">
                ...
                <textarea rows={3} type="email" id="email" class="border border-gray-300 text-black
                    ...
                    <span class='w-135 pl-3 pt-1 text-sm block'>Mention more details of the applicant's business such as Food Products manufacturer, Retail Trade of spices, Automobile company, Computer Programming, etc.</span>
            </div>
            <div class="my-3 flex justify-between">
                    <div>
            ...
            <div class="my-3">
                    ...
                    <span class='w-135 pl-3 pt-1 text-sm block'>Enter the 10-digit unique alphanumeric number mentioned on the applicant's PAN CARD.</span>
            </div>
        </form>
        <button type="submit" class="w-full text-white bg-black font-medium rounded-lg text-sm px-5 my-2 py-2.5 text-center">Submit Application</button>
