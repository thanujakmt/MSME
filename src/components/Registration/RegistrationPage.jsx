    ...
    return (
        <div>
            <div class={`w-screen relative`}>
                <img src='../src/assets/urban-skyline.png' class="w-screen relative z-1" />
                <div class={"text-white absolute absolute inset-0 flex flex-col items-center justify-center z-2"}>
                    <span class="text-3xl">Udyam Registration 2025</span><br/>
                    <span class="text-xl">A Udyam registration certificate is necessary to obtain loans from banks and benefits provided</span>
                    <span> under various schemes to MSMEs.
                         - The Udyam registration certifies that an enterprise is</span>
                         <span> covered under the MSME category</span><br/>
                    <span class="text-xl">(उद्यम पंजीकरण प्रमाणपत्र: सूक्ष्म, लघु और मध्यम उद्यमों के लिए)</span><br/>
                    <span class="text-xl">(आइए आत्मनिर्भर भारत अभियान को सफल बनाने का प्रयास करें!)</span>
                </div>
            </div>
            <div class='flex justify-between items-start px-10 pt-10 pb-3'>
                <Form />
                <div class='px-5 pb-5'>
                    <img src='../src/assets/Register_certificate.png' class="w-160" />
                    <div class='p-5 w-160'>
                        <p class='text-orange-500 text-2xl font-bold w-100 pb-2'>What is a New Udyam Registration Certificate?</p>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-2'>Defining New Udyam Registration Certificate?</p>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-2'>Featured Benefits of Udyam Registration Certificate</p>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-3'>Let's Explore who can Apply for Udyam Registration Certificate?</p>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-3'>Documents Required for Udyam Registration</p>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-3'>Steps to Register on the MSME Registration Portal</p>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-3'>Downloading and Verifying your Udyam Registration Certificate</p>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-3'>Here are some common mistakes which should be avoided during Registration</p>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-3'>Some Frequently Asked Questions for more clarification</p>
            ...
            <div class='px-10 pt-3 pb-6'>
                <p class='text-orange-500 text-2xl font-bold pb-8'>Register yourself on MSME Registration Portal today!</p>
