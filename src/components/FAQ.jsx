...
function FAQ() {
    ...
    return (
        <div class="overflow-hidden shadow-lg w-screen p-6 bg-white p-4">
            ...
            <p class="text-orange-500 text-2xl pb-5 pt-2 font-bold">Frequently Asked Questions</p>
            ...
            <div class="pt-2">
                <span className="text-sm">Contact Us On -</span>
                <ul class="list-disc px-5 pb-5">
                    ...
                    <li class="text-sm">Our Website - <a href="www.msmeregistration.in" className="text-blue-300 underline">www.msmeregistration.in</a></li>
                </ul>
                <p className="text-sm">You can join 1000+ successful Indian Entrepreneurs who have already been enrolled in the power of MSME Registration Platform. Do not miss this chance to get ahead of the curve. <b>All of these are just a few clicks away!</b></p>
                <p class="py-5 text-sm"><b>Hurry up!</b> Don't miss the chance for this extensive government schemes, financial advantages, and opportunities to grow business that come with official MSME status.</p>
                <p class="py-5 text-sm">Our aim is to ensure you that your registration process will be smooth, secure and successful.</p>
                <p class="text-sm">So take your step to expand your business today because your success story starts from now!</p>
                <p class="text-sm"><b>ACT NOW, GROW AHEAD, GROW FASTER!</b></p>
                <p class="text-sm"><b>Register Now</b> : <a href="MSMERegistration.in" className="text-blue-300 underline">MSMERegistration.in</a> with your growth partner!</p>
            </div>
        </div>
