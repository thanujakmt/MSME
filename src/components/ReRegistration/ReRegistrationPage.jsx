    ...
    return (
        <div>
            <div className=' 2xl:h-[700px]'>
                <img src='../src/assets/Re-Register_banner.png' className=' h-full w-full' />
            </div>
            <div className='lg:flex lg:justify-evenly lg:items-start px-10 pt-10 pb-3'>
                <div>
                    <ReRegistrationForm />
                </div>
                <div className='py-5 px-5 2xl:py-0  lg:h-[660px] lg:w-[600px]'>
                    <img src='../src/assets/ReRegister_certificate.png' className=" h-full w-full" />
                </div>
            </div>
            <div className='md:px-[20px]  2xl:px-[150px] py-[20px]'>
                <div className='px-10 py-3'>
                    <p className='text-pale_yellow text-2xl font-bold pb-2'>Udyam Re-Registration Certificate: Why is it Important</p>
                ...
                <div className='px-10 py-3'>
                    <p className='text-pale_yellow text-2xl font-bold pb-2'>Importance of Re-Registration</p>
                    <p className='text-sm pb-3'>By completing the Udyam Re-registration, MSMEs can get many benefits, due to which they can run their business in a more right direction. Here are some important</p>
                    ...
                    <p className='text-sm pt-3'>These are some advantages. The Government of India always brings new schemes for the upliftment of MSMEs, and those schemes benefit only Udyam-registered MSMEs.</p>
                </div>
                <div className='px-10 py-3'>
                    <p className='text-pale_yellow text-2xl font-bold pb-3'>Documents required for Udyam Re-registration</p>
                    <p className='text-sm pb-3'>Whenever MSMEs have to migrate from the old <span className='underline'>Udyog Aadhaar</span> to Udyam Re Registration, then MSMEs need all these documents:</p>
                    <ul className="list-disc pl-8">
                ...
                <div className='px-10 pt-3 pb-8'>
                    ...
                    <ul className="list-disc pl-8">
                        ...
                        <li className='text-sm leading-6'>The Udyam Migration Consultancy/ Re-registration form appears on the screen. All the information asked for in the form will have to be filled out correctly.</li>
                        <li className='text-sm leading-6'>The information asked in the form is</li>
                        <ul className="list-disc pl-8">
                            <li className='text-sm leading-6'>Applicant's name</li>
                            <li className='text-sm leading-6'>Mobile number</li>
                            <li className='text-sm leading-6'>Email ID</li>
                            <li className='text-sm leading-6'>Old Udyog Aadhar Memorandum number</li>
                        </ul>
                        <li className='text-sm leading-6'>After filling in all this information, select your state from the drop-down box.</li>
                        <li className='text-sm leading-6'>After that, you will have an option to provide details of any changes you want to your existing Udyog Udyam certificate.</li>
                        <ul className="list-disc pl-8">
                            <li className='text-sm leading-6'>If you want, click on the yes option and write the details in the box that you want to update on your certificate.</li>
                            <li className='text-sm leading-6'>If you do not want to make any changes, then click no and proceed further.</li>
                        </ul>
                        <li className='text-sm leading-6'>After that, agree to the Terms of Service and Declaration box and tick the mark in it.</li>
                        <li className='text-sm leading-6'>Fill in the captcha code that will be visible on your screen in the given box.</li>
                        <li className='text-sm leading-6'>Finally, click on Submit Application.</li>
                        <li className='text-sm leading-6'>After clicking on the Submit Application, you will directly reach our payment gateway, and after paying some nominal charges, your Udyam Re registration process will be completed. Its confirmation message will be provided to you on your given email ID.</li>
                    </ul>
                </div>
            </div>
        </div>
