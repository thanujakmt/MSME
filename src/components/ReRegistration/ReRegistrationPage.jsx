...
function ReRegistrationPage() {
    return (
        <div>
            <div class={`w-screen`}>
                <img src='../src/assets/Re-Register_banner.png' class="w-screen" />
            </div>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-2'>Udyam Re-Registration Certificate: Why is it Important</p>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-2'>Importance of Re-Registration</p>
            ...
            <div class='px-10 py-3'>
                <p class='text-orange-500 text-2xl font-bold pb-3'>Documents required for Udyam Re-registration</p>
            ...
            <div class='px-10 pt-3 pb-8'>
                <p class='text-orange-500 text-2xl font-bold pb-3'>Process of Udyam Re-registration</p>
